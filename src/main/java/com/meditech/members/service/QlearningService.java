...
//        int state = new Random().nextInt(NUM_STATES);
        ...
        System.out.println("Q-learning session 결과: "+ session.getAttribute("patientAction"));
        System.out.println(session.getAttribute("patientReward"));
        System.out.println(session.getAttribute("patientNextState"));
    }
